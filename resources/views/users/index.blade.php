<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">
            {{ Auth::user()->name }}
            <b style="float: right;"> Total Pengguna
                <span class="text-gray-900 bg-gradient-to-r from-red-200 via-red-300 to-yellow-200 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-red-100 dark:focus:ring-red-400 font-medium rounded-lg text-md px-5 py-2.5 text-center mr-2 mb-2">
                    {{ count($user) }}</span>
            </b>
        </h2>
    </x-slot>
            ...
            <div class="bg-white">
                <table class="table-auto w-full">
                    ...
                    <tr>
                        ...
                        <th class="border px-6 py-4">created_at</th>
